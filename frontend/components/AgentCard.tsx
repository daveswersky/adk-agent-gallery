...
export const AgentCard: React.FC<AgentCardProps> = ({ agent, onStart, onStop, onSelect, onViewCode }) => {
    ...
    >
      ...
      <div className="flex items-center justify-end space-x-2">
        ...
        <button
          ...
          className="p-2 text-sm font-medium rounded-md bg-adk-dark-3 hover:bg-gray-600 text-adk-text flex items-center"
